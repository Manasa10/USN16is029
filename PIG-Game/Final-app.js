...
*/
/*
The files Final-app.js, index.html and style.css correspond to the initial version of pig game with
 a single dice. If the dice rolls a 1 or 2 consecutive sixes then it is the turn of the next player.
...
document.querySelector('.btn-roll').addEventListener("click", function() {
    if(gamePlaying) {
        ...
        if (dice !== 1) {
            //checking for 2 consecutive sixes
